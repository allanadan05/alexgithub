				                      ...
				                      <!--/2nd panel-->
				                       ...
				                       <!--3rd panel-->
				                                           <div class="panel-heading" id="billing"><b>Billing Address</b>
				                                           	...
				                                           	<span style="float: right;">
				                                           	<a href="accountbilling.php#billing">
					                                    	<button type="submit" class="primary-btn" > <i class="fa fa-edit"></i>  Edit </button> 
					                                        </a>
					                                    	</span>
				                                                 ...
				                                                 <div class="panel-body">
				                                                     ...
				                                                     <div class="col-md-6">
				                                                     	<table class="table table-responsive table-hover">
				                                                     		<tr>
				                                                     			<th style="text-align: right;">Address: </th>
				                                                     			<td>B4 L3 Centerville Subdivision, Barangay Sto. Cristo, City of San Jose Del Monte, Bulacan 3023</td>
				                                                     		</tr style="text-align: right;">
				                                                     	</table>
				                                                      </div>
                                                                  </div>
				                                                     ...
				                                                     <div class="Address-details">
				                                                     			...
				                                                     			<table class="table table-responsive table-hover">
				                                                     				<tr>
				                                                     					...
				                                                     					<td><input type="text" name="email" value="steven123francisco@gmail.com" required> </td>
				                                                     				</tr style="text-align: right;">
				                                                     				<tr>
				                                                     					<th style="text-align: right;">Username: </th>
				                                                     					<td><input type="text" name="firstname" value="Stevenigop" required> </td>
				                                                     				</tr>
				                                                     				<tr>
