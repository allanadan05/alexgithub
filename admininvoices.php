                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <input class="input" placeholder="Search here" style="width: 500px;" autofocus >
                                                    <span>
                                                    <button class="primary-btn" style="border-radius: 0px 25px 25px 0px;">Search</button>
                                                    </span>
                                                    <br>
                                                    ...
                                                    <table class="table table-responsive table-hover">
                                                       ...
                                                       <tr>
                                                         ...
                                                         <td> ₱ 360.00</td>
                                                         <td> 
                                                            <a href="admininvoicegenerate.php?ID=0">
                                                            <button class="btn btn-primary"> <span><i class="fa fa-view"></i></span> VIEW </button> 
                                                            </a>
                                                        </td>
                                                       </tr>
                                                       <tr>
