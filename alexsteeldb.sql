...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2019 at 02:22 PM
...
--
-- Truncate table before insert `carttbl`
--

TRUNCATE TABLE `carttbl`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `deliverytbl`
--

TRUNCATE TABLE `deliverytbl`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `feedbacktbl`
--
...
--
-- Truncate table before insert `invoicetbl`
--

TRUNCATE TABLE `invoicetbl`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `messagingtbl`
--

TRUNCATE TABLE `messagingtbl`;
--
...
--
-- Truncate table before insert `myaccountbalances`
--

TRUNCATE TABLE `myaccountbalances`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `myaccountpurchases`
--

TRUNCATE TABLE `myaccountpurchases`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `myaccounttbl`
--

TRUNCATE TABLE `myaccounttbl`;
--
...
--
-- Truncate table before insert `notificationstbl`
--

TRUNCATE TABLE `notificationstbl`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `productstbl`
--

TRUNCATE TABLE `productstbl`;
--
...
(1, 'Pipes1575879779', 'Pipes', 'B.I. & G.I. Pipes', 'uploads/product_1575879779_5_1.jpg', 600, 700, 1000, 'made of steel that has not been galvanized. Its name comes from the scaly, dark-colored iron oxide coating on its surface that prevents rust. Black steel pipes are cut and threaded to fit.', 'Used for pipes in oil and petroleum industries\r\nFor water, gas and sewerage purposes\r\nLow-pressure hot water heating pipes\r\nWater wells and pipes for various automotive and industrial applications', '', 'Philipines'),
(2, 'BI Pipes1575880009', 'BI Pipes', 'B.I. & G.I. Pipes', 'uploads/product_1575880009185313_239046469_8a601de0_1.jpg', 500, 600, 1000, 'made of steel that has not been galvanized. Its name comes from the scaly, dark-colored iron oxide coating on its surface that prevents rust. Black steel pipes are cut and threaded to fit.', 'Used for pipes in oil and petroleum industries\r\nFor water, gas and sewerage purposes\r\nLow-pressure hot water heating pipes\r\nWater wells and pipes for various automotive and industrial applications', '', 'Philipines'),
...
(39, 'Chanels1575960965', 'Chanels', 'Channels', 'uploads/product_1575960965r.jpg', 200, 300, 2000, 'peforated steel chanel', 'A peforated steel chanel is usually formed from a metal sheet, folded over into an open channel shape with inwards-curving lips to provide additional stiffness and as a location to mount interconnecting components', '', 'Philipines'),
(40, 'Chanels1575961108', 'Chanels', 'Channels', 'uploads/product_1575961108t.jpg', 400, 500, 2000, 'Rolled Channel Steel Bar', ' Rolled Channel Steel Bar\r\n U channel steel bar can be supplied in different grades.Dimension: 51*25*3mm-305*80*13mmBar Thickness: 3mm-13mmSteel Bar Length: 6m,9m, 12m', '', 'Philipines'),
...
--
-- Truncate table before insert `salestbl`
--

TRUNCATE TABLE `salestbl`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `wishlisttbl`
--

TRUNCATE TABLE `wishlisttbl`;
