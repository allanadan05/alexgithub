				                      ...
				                      <div id="myaccount-details" class="col-md-8">
				                             ...
				                             <div class="panel panel-info">
				                                    <div class="panel-heading" id="personal">
				                                    	...
				                                    	<a href="">
				                                    	<button type="submit" name="savepersonal" class="primary-btn" style="background-color: #0000b3;" > <i class="fa fa-save"></i>  Save</button> 
				                                    	</a>
				                                    	</span>
				                                             	...
				                                             	<div class="Address-details">
				                                                     <div class="col-md-6">
				                                                     	...
				                                                     	<table class="table table-responsive table-hover">
				                                                     		...
				                                                     		<tr>
				                                                     			<th style="text-align: right;">Company TIN no: </th>
				                                                     			<td>  <input type="text" name="tin" value="<?php echo $result['tin']; ?>" ></td>
				                                                     		</tr>
				                                                     	
				                                                     		<tr>
				                                                     			<th style="text-align: right;">Gender: </th>
				                                                     			<td> <input type="text" name="gender" value="<?php echo $result['gender']; ?>" required> </td>
				                                                     		</tr>
				                                                     		<tr>
				                                                     			<th style="text-align: right;">Mobile no: </th>
				                                                     			<td> <input type="text" name="firstname" value="<?php echo $result['mobileno']; ?>" required> </td>
				                                                     		</tr>
				                                                     	</table>
				                                                       </form>
				                                                      </div>
				                                                     ...
				                                                     <div class="col-md-6">
				                                                     	<table class="table table-responsive table-hover">
				                                                     		<tr>
				                                                     			...
				                                                     			<td>
				                                                     				<input class="form-control inputLogin" type="text" placeholder="House no./Stree no." name="houseno" value="<?php echo $result['houseno']; ?>">

																		            <input class="form-control inputLogin" type="text" placeholder="Barangay" name="barangay"  value="<?php echo $result['barangay']; ?>">

																		            <input class="form-control inputLogin" type="text" placeholder="Municipal/City" name="municipal"  value="<?php echo $result['municipal']; ?>">

																		            <input class="form-control inputLogin" type="text" placeholder="Province" name="province"  value="<?php echo $result['province']; ?>">
