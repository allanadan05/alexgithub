...
-- Generation Time: Dec 14, 2019 at 04:13 AM
...
-- Database: `dbs242190`
--
CREATE DATABASE IF NOT EXISTS `dbs242190` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `dbs242190`;
...
(13, 'user1576059810', 3, 900, 1, 900),
(14, 'user1576059810', 2, 600, 1, 600);
...
--
-- Truncate table before insert `commenttbl`
--

TRUNCATE TABLE `commenttbl`;
--
...
CREATE TABLE IF NOT EXISTS `liketbl` (
...
--
-- Truncate table before insert `liketbl`
--

TRUNCATE TABLE `liketbl`;
--
