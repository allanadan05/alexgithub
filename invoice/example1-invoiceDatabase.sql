...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 11, 2018 at 07:34 AM
...
-- Database: `invoicedb`
--
CREATE DATABASE IF NOT EXISTS `invoicedb` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `invoicedb`;
